...
Persist this block in the configured project state when work remains. `lastHarness`
may be diagnostic metadata only; it never selects authority or controls resume.
